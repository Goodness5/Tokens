...
contract W3BVIII{ 
    // / @param TOKEN_OWNER contains address of token
    ...
    /// @custom:balanceof GETS THE BALANCE TOKEN OF EACH TOKEN HOLDER
    ...
    /// @custom:allowance  CHECK IF THIRD PARTY HAS BEEN APPROVED TO USE HOLDER'S TOKENS
    ...
    /// @custom:transferfrom ALLOW THIRD PARTIES TO INITIATE TOKEN TRANSFER IF APPROVED
    ...
    /// @custom:burn SEND BURNT TOKENS TO THE ZERO ADDRESS
